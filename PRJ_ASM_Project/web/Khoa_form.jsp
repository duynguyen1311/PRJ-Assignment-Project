                ...
                <div class="sidebar-wrapper active">
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            ...
                            <li class="sidebar-item">
                                <a href="table_fixed1.html" class='sidebar-link'>
                            ...
                            <li class="sidebar-item">
                                <a href="table_fixed2.html" class='sidebar-link'>
                            ...
                            <li class="sidebar-item">
                                <a href="table_fixed3.html" class='sidebar-link'>
                            ...
                            <li class="sidebar-item  has-sub">
                                ...
                                <ul class="submenu ">
                                    <li class="submenu-item ">
                                        <a href="table_fixed4.html">Danh sách sinh viên</a>
                                    </li>
                                    <li class="submenu-item ">
                                        <a href="table_fixed5.html">Điểm</a>
                                    </li>
                                </ul>
                            </li>
